...
public class SpacePe : ISpacePe, IExtensibleDataObject
{
    public SpacePe(string name, string shortname, string authors, string description, string goals,
        int requiredPoints, ISpaceLayoutPe? spaceLayout = null, double positionX = 0, double positionY = 0,
        List<IObjectInPathWayPe>? inBoundObjects = null, List<IObjectInPathWayPe>? outBoundObjects = null)
    {
        ...
        SpaceLayout = spaceLayout ?? new SpaceLayoutPe(null, null);
    ...
    private SpacePe()
    {
        ...
        Goals = "";
        RequiredPoints = 0;
        SpaceLayout = new SpaceLayoutPe(null, null);
    ...
    [DataMember]
    public ISpaceLayoutPe SpaceLayout { get; set; }
    [IgnoreDataMember]
