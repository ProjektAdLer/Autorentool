...
public class LearningElementViewModel : ILearningObjectViewModel
{
    ...
    /// <param name="content">Describes the type of content the learning elements contains.</param>
    ...
    public LearningElementViewModel(string name, string shortname, string content, string authors, string description,
        string goals, double positionX = 0, double positionY = 0)
    {
        Name = name;
        Shortname = shortname;
        Content = content;
