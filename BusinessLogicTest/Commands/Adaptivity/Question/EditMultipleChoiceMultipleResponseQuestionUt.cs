...
public class EditMultipleChoiceMultipleResponseQuestionUt
{
    ...
    public void Execute_EditsMultipleChoiceMultipleResponseQuestion()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(question.Choices.Count, Is.Not.EqualTo(4));
            ...
            Assert.That(question.CorrectChoices.Count, Is.Not.EqualTo(2));
    ...
    public void Undo_UndoesEditMultipleChoiceMultipleResponseQuestion()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(question.CorrectChoices.Count, Is.EqualTo(oldCorrectChoices.Count));
