...
public class BatchCommandUt
{
    ...
    public void Execute_Undo_Redo_BatchCommand()
    {
        ...
        var spaceCommandFactoryLogger = Substitute.For<ILogger<SpaceCommandFactory>>();
        var topicCommandFactoryLogger = Substitute.For<ILogger<TopicCommandFactory>>();
        ...
        var command1 = new CreateLearningSpace(world, "a", "b", "c", 2, Theme.Campus,
            0, 0, null, mappingAction: mappingAction1, logger: spaceCommandFactoryLogger);
        var command2 = new CreateTopic(world, name, mappingAction2, topicCommandFactoryLogger);
