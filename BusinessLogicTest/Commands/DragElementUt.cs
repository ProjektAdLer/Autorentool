...
public class DragElementUt
{
    [Test]
    public void Execute_DragsElement()
    {
        double oldPositionX = 1;
        double oldPositionY = 2;
        double newPositionX = 3;
        double newPositionY = 4;
        var element = new Element("a", "b", null!,"c", "d", "e", 
            "f", ElementDifficultyEnum.Easy, null, 5, 5, newPositionX, newPositionY);
        bool actionWasInvoked = false;
        Action<Element> mappingAction = _ => actionWasInvoked = true;

        var command = new DragElement(element, oldPositionX, oldPositionY, newPositionX, newPositionY, mappingAction);
    ...
    [Test]
    public void UndoRedo_UndoesAndRedoesDragElement()
    {
        double oldPositionX = 1;
        double oldPositionY = 2;
        double newPositionX = 3;
