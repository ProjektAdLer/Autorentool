...
public class PlaceStoryElementInLayoutFromLayoutUt
{
    ...
    private PlaceStoryElementInLayoutFromLayout GetSystemUnderTest(LearningSpace parentSpace, ILearningElement learningElement, int newSlotIndex, Action<LearningSpace> mappingAction, ILogger<PlaceStoryElementInLayoutFromLayout> logger)
    {
        return new PlaceStoryElementInLayoutFromLayout(parentSpace, learningElement, newSlotIndex, mappingAction, logger);
    }
}