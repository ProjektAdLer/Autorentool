...
public class CommandStateManagerUt
{
        ...
        ExecuteCommandAfterRedoingAnCommand_TriggersRemovedCommandsFromStacksWithRemainingCommandsInStacks_AllCommandTypes()
    {
        ...
        var createLearningElementCommand = new CreateLearningElementInSlot(learningSpace, 0, learningElement, _ => { }, logger);
        ...
        var deleteLearningElementCommand = new DeleteLearningElementInSpace(learningElement, learningSpace, _ => { }, logger);
        ...
        var loadLearningElementCommand = new LoadLearningElement(learningSpace, 0, "e", mockBusinessLogic, _ => { }, logger);
