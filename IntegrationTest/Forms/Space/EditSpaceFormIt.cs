...
public class EditSpaceFormIt : MudFormTestFixture<EditSpaceForm, LearningSpaceFormModel, LearningSpace>
{
    ...
    public void SubmitThenRemapButton_CallsPresenterWithNewValues_ThenRemapsEntityIntoForm()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(() => FormModel.SpaceTheme, Is.EqualTo(SpaceTheme.CampusAschaffenburg).After(300, 10));
        });
        ...
        SpacePresenter.Received(2).EditLearningSpace(Expected, Expected, 123, SpaceTheme.CampusAschaffenburg);
