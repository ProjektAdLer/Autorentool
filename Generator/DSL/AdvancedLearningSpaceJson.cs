...
public class AdvancedLearningSpaceJson : IAdvancedLearningSpaceJson
{
    ...
    public AdvancedLearningSpaceJson(int spaceId, string spaceUuid, string spaceName,
        List<int?> spaceSlotContents, int requiredPointsToComplete, object advancedLearningSpaceLayout, string spaceTheme,
    ...
    public object AdvancedLearningSpaceLayout { get; set; }
