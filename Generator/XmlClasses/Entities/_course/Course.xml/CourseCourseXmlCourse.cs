...
public class CourseCourseXmlCourse : ICourseCourseXmlCourse
{
    ...
    public CourseCourseXmlCourse(int contextId)
    {
        Shortname = "";
        Fullname = "";
        IdNumber = "";
    ...
    [XmlElement(ElementName = "summary")] public string Summary { get; set; }

    [XmlElement(ElementName = "summaryformat")]
    public string SummaryFormat { get; set; }

    [XmlElement(ElementName = "format")] public string Format { get; set; }
    ...
    [XmlElement(ElementName = "marker")] public string Marker { get; set; }

    [XmlElement(ElementName = "maxbytes")] public string Maxbytes { get; set; }
    ...
    [XmlElement(ElementName = "visible")] public string Visible { get; set; }
    ...
    [XmlElement(ElementName = "theme")] public string Theme { get; set; }
    ...
    [XmlElement(ElementName = "category")] public CourseCourseXmlCategory Category { get; set; }
