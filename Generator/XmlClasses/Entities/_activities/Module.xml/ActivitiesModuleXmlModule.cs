...
public class ActivitiesModuleXmlModule : IActivitiesModuleXmlModule
{
    ...
    [XmlElement(ElementName = "added")] public string Added { get; set; }

    [XmlElement(ElementName = "score")] public string Score { get; set; }

    [XmlElement(ElementName = "indent")] public string Indent { get; set; }
    ...
    [XmlElement(ElementName = "completionpassgrade")]
    public string Completionpassgrade { get; set; }
