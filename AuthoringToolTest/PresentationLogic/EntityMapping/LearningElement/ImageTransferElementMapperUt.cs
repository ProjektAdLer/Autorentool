...
public class ImageTransferElementMapperUt
{
    [Test]
    public void ImageTransferElementMapper_ToEntity_MapsPropertiesCorrectly()
    {
    ...
    [Test]
    public void ImageTransferElementMapper_ToViewModel_MapsPropertiesCorrectly()
    {
        var contentMapper = Substitute.For<ILearningContentMapper>();
    ...
    private ImageTransferElementMapper CreateTestableLearningElementMapper(ILogger<ImageTransferElementMapper>? logger = null, ILearningContentMapper? contentMapper = null)
    {
        logger ??= Substitute.For<ILogger<ImageTransferElementMapper>>();
        contentMapper ??= Substitute.For<ILearningContentMapper>();
        return new ImageTransferElementMapper(logger, contentMapper);
    }
}