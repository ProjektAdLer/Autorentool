...
public class ImageTransferElementMapperUt
{
    ...
    private ImageTransferElementMapper CreateTestableLearningElementMapper(ILearningContentMapper? contentMapper = null)
    {
        contentMapper ??= Substitute.For<ILearningContentMapper>();
        return new ImageTransferElementMapper(contentMapper);
    }
}