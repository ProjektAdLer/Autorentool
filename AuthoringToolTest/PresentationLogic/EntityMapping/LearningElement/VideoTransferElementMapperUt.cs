...
public class VideoTransferElementMapperUt
{
    [Test]
    public void VideoTransferElementMapper_ToEntity_MapsPropertiesCorrectly()
    {
    ...
    [Test]
    public void VideoTransferElementMapper_ToViewModel_MapsPropertiesCorrectly()
    {
        var contentMapper = Substitute.For<ILearningContentMapper>();
