...
public class ContentFilesViewUt
{
    ...
    public void ClickDelete_ShowsDialog_DeletesOnOkIfNotInWorlds()
    {
        ...
        _presentationLogic.Received(1).DeleteContent(Arg.Any<IAuthoringToolWorkspaceViewModel>(), items.First());
    }
    ...
    public void ClickDelete_ArgumentOutOfRangeException_CallsErrorService()
    {
        ...
        _presentationLogic.When(x => x.DeleteContent(Arg.Any<IAuthoringToolWorkspaceViewModel>(), items.First())).Throw(new ArgumentOutOfRangeException());
    ...
    public void ClickDelete_FileNotFoundException_CallsErrorService()
    {
        ...
        _presentationLogic.When(x => x.DeleteContent(Arg.Any<IAuthoringToolWorkspaceViewModel>(), items.First())).Throw(new FileNotFoundException("test"));
    ...
    public void ClickDelete_SerializationException_CallsErrorService()
    {
        ...
        _presentationLogic.When(x => x.DeleteContent(Arg.Any<IAuthoringToolWorkspaceViewModel>(), items.First())).Throw(new SerializationException("test"));
    ...
    public void ClickDelete_ShowsDialog_ShowsAnotherDialogWhenInWorld_CancelDoesNotDelete()
    {
        ...
        _dialogService.Received(1).ShowAsync<DeleteContentInUseConfirmationDialog>("WarningDialog.Title",
            ...
            Arg.Any<DialogOptions>());
        _presentationLogic.DidNotReceiveWithAnyArgs().DeleteContent(Arg.Any<IAuthoringToolWorkspaceViewModel>(), Arg.Any<ILearningContentViewModel>());
    }
