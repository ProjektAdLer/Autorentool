...
#pragma warning disable CS8618 // set in setup - n.stich
    ...
    private IWorldPresenter _positioningService;
#pragma warning restore CS8618
    ...
    public void Setup()
    {
        ...
        _positioningService = Substitute.For<IWorldPresenter>();
    ...
    private IRenderedComponent<Presentation.View.PathWay.PathWay> GetPathWayForTesting( double x1 = 0, double y1 = 0, double x2 = 0,
        double y2 = 0, IPathWayViewModel? pathWay =null, Action<IPathWayViewModel>? onClicked = null)
    {
        onClicked ??= _ => { };
        return _ctx.RenderComponent<Presentation.View.PathWay.PathWay>(parameters => parameters
            .Add(p => p.PathWayViewModel, pathWay)
            .Add(p => p.X1, x1)
            .Add(p => p.Y1, y1)
            .Add(p => p.X2, x2)
            .Add(p => p.Y2, y2)
