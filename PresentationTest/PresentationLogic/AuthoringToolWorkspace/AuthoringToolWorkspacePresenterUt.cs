...
public class AuthoringToolWorkspacePresenterUt
{
    ...
    {
        var learningWorld = new LearningWorldViewModel("unsaved", "f", "f", "f", "f", "f", "f", "f", "f", "f")
        {
            UnsavedChanges = true
        };
        var presentationLogic = Substitute.For<IPresentationLogic>();
    ...
    {
        var learningWorld = new LearningWorldViewModel("saved", "f", "f", "f", "f", "f", "f", "f", "f", "f")
        {
    ...
    {
        var presentationLogic = Substitute.For<IPresentationLogic>();
        var learningWorld = new LearningWorldViewModel("fo", "f", "", "f", "", "", "f", "f", "f", "f");
        var selectedViewModelsProvider = Substitute.For<ISelectedViewModelsProvider>();
    ...
    public async Task OnBeforeShutdown_CallsDialogService_ForEveryUnsavedWorld_AndCallsSaveOnYesResponse()
    {
        ...
        var unsavedWorld = new LearningWorldViewModel("unsaved", "f", "f", "f", "f", "f", "f", "f", "f", "f")
        {
            UnsavedChanges = true
        };
        var savedWorld = new LearningWorldViewModel("unsaved", "f", "f", "f", "f", "f", "f", "f", "f", "f")
        {
            UnsavedChanges = false
        };
