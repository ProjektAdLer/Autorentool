...
public class LearningSpacePresenterUt
{
    ...
    public void EditLearningSpace_LearningSpaceVmIsNull_SetsError()
    {
        ...
        systemUnderTest.EditLearningSpace("a", "d", 5, SpaceTheme.CampusAschaffenburg, null);
    ...
    public void EditLearningSpace_CallsPresentationLogic()
    {
        ...
        systemUnderTest.EditLearningSpace("space", "d", 5, SpaceTheme.CampusAschaffenburg, topic);

        presentationLogic.Received().EditLearningSpace(space, "space", "d", 5, SpaceTheme.CampusAschaffenburg, topic);
    }
