...
public class LearningSpaceViewModelUt
{
    ...
    public void Constructor_InitializesAllProperties()
    {
        ...
        var systemUnderTest = new LearningSpaceViewModel(name, description, SpaceTheme.CampusAschaffenburg,
            requiredPoints,
            learningOutcomes,
    ...
    public void FileEnding_ReturnsCorrectEnding()
    {
        ...
        var systemUnderTest = new LearningSpaceViewModel("foo", "foo", SpaceTheme.CampusAschaffenburg);
    ...
    {
        var systemUnderTest = new LearningSpaceViewModel("a", "d", SpaceTheme.CampusAschaffenburg,
