...
using ModalDialogOnCloseResult = AuthoringToolLib.Components.ModalDialog.ModalDialogOnCloseResult;
using ModalDialogReturnValue = AuthoringToolLib.Components.ModalDialog.ModalDialogReturnValue;

namespace AuthoringToolLib.PresentationLogic.LearningSpace;
