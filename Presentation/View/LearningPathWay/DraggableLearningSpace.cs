...
public class DraggableLearningSpace : DraggableObjectInPathWay
{
    protected override void OnInitialized()
    {
        ...
        ObjectShape =
            @"<rect height=""50"" width=""100"" style=""fill:lightgreen;stroke:black;stroke-width:{0}""></rect> 
                                    <text x=""3"" y=""15"">{1}</text>";
        DeletePathButtonShape = @"<circle r=""6"" transform=""translate(50, 0)"" fill=""white"" stroke=""gray""/>
