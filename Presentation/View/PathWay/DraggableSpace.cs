...
public class DraggableSpace : DraggableObjectInPathWay
{
    protected override string ObjectName => ((ISpaceViewModel)ObjectInPathWay).Name;
    ...
    public EventCallback<ISpaceViewModel> OnOpenSpace { get; set; }
    [Parameter, EditorRequired]
    public EventCallback<ISpaceViewModel> OnEditSpace { get; set; }
    [Parameter, EditorRequired]
    public EventCallback<ISpaceViewModel> OnDeleteSpace { get; set; }
    protected override List<RightClickMenuEntry> GetRightClickMenuEntries()
    {
        return new List<RightClickMenuEntry>()
        {
            new("Open", () => OnOpenSpace.InvokeAsync((ISpaceViewModel)ObjectInPathWay)),
            new("Edit", () => OnEditSpace.InvokeAsync((ISpaceViewModel)ObjectInPathWay)),
            new("Delete", () => OnDeleteSpace.InvokeAsync((ISpaceViewModel)ObjectInPathWay)),
        };
    }
}