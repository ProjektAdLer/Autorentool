...
{
    [UsedImplicitly]
    private StructuredLearningOutcomeViewModel()
    {
    ...
    public StructuredLearningOutcomeViewModel(TaxonomyLevel taxonomyLevel, string what, string whereby, string whatFor,
