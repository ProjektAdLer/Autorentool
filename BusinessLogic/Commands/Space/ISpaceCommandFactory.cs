...
public interface ISpaceCommandFactory
{
    ...
    ICreateLearningSpace GetCreateCommand(LearningWorld learningWorld, string name,
        string description, LearningOutcomeCollection learningOutcomeCollection, int requiredPoints, SpaceTheme spaceTheme,
        double positionX,
        double positionY,
    ...
    IEditLearningSpace GetEditCommand(ILearningSpace learningSpace, string name,
        string description, int requiredPoints, SpaceTheme spaceTheme, Entities.Topic? topic,
