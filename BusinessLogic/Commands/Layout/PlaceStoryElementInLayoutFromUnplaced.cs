...
public class PlaceStoryElementInLayoutFromUnplaced : IPlaceStoryElementInLayoutFromUnplaced
{
    ...
    public void Execute()
    {
        ...
        LearningSpace.LearningSpaceLayout.StoryElements.TryGetValue(NewSlotIndex, out var oldElement);
        if (oldElement != null)
        {
        ...
        LearningSpace.LearningSpaceLayout.StoryElements[NewSlotIndex] = LearningElement;

        Logger.LogTrace(
            "Placed StoryElement {LearningElementName} ({LearningElementId}) from UnplacedLearningElements to slot {NewSlotIndex} of LearningSpace {LearningSpaceName}({LearningSpaceId}) in LearningWorld {LearningWorldName} ({LearningWorldId})",
