...
public class CreateMultipleChoiceMultipleResponseQuestion : ICreateMultipleChoiceMultipleResponseQuestion
{
    ...
    public void Execute()
    {
        ...
        Logger.LogTrace(
            "Created MultipleChoiceMultipleResponseQuestion {QuestionName} ({QuestionText}) in AdaptivityTask {AdaptivityTaskName}",
    ...
    public void Undo()
    {
        ...
        Logger.LogTrace(
            "Undone creation of MultipleChoiceMultipleResponseQuestion {QuestionName} ({QuestionText}). Restored AdaptivityTask {AdaptivityTaskName} to previous state",
            Question.Text, Question.Text, AdaptivityTask.Name);
